...
public class ApplicationConfig extends Application {
    ...
    public Set<Class<?>> getClasses() {
        ...
        resources.add(com.nabisoft.tutorials.jerseyjackson.jaxrs.resource.CommentResource.class);
        resources.add(com.nabisoft.tutorials.jerseyjackson.jaxrs.resource.CommentsResource.class);
        resources.add(com.nabisoft.tutorials.jerseyjackson.jaxrs.resource.EmployeeResources.class);
